...
class VisionDetection(metaclass=Metaclass_VisionDetection):
    ...
    def __init__(self, **kwargs):
        ...
        self.pixel_width = kwargs.get('pixel_width', float())
    ...
    def pixel_width(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'pixel_width' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'pixel_width' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
