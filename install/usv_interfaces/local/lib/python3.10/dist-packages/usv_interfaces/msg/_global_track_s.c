...
bool usv_interfaces__msg__global_track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // track_id
    ...
    if (!unique_identifier_msgs__msg__uuid__convert_from_py(field, &ros_message->track_id)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // source_model_name
    PyObject * field = PyObject_GetAttrString(_pymsg, "source_model_name");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->source_model_name, PyBytes_AS_STRING(encoded_field));
...
PyObject * usv_interfaces__msg__global_track__convert_to_py(void * raw_ros_message)
{
  ...
  {  // track_id
    PyObject * field = NULL;
    field = unique_identifier_msgs__msg__uuid__convert_to_py(&ros_message->track_id);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // source_model_name
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->source_model_name.data,
      strlen(ros_message->source_model_name.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "source_model_name", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
