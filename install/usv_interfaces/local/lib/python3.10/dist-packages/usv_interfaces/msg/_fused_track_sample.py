...
class Metaclass_FusedTrackSample(type):
    """Metaclass of message 'FusedTrackSample'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__fused_track_sample
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__fused_track_sample
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__fused_track_sample
            cls._TYPE_SUPPORT = module.type_support_msg__msg__fused_track_sample
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__fused_track_sample
...
class FusedTrackSample(metaclass=Metaclass_FusedTrackSample):
    """Message class 'FusedTrackSample'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.t_sec = kwargs.get('t_sec', float())
    ...
    @t_sec.setter
    def t_sec(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 't_sec' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 't_sec' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._t_sec = value
