...
class Metaclass_FusedTargetSnapshot(type):
    """Metaclass of message 'FusedTargetSnapshot'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__fused_target_snapshot
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__fused_target_snapshot
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__fused_target_snapshot
            cls._TYPE_SUPPORT = module.type_support_msg__msg__fused_target_snapshot
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__fused_target_snapshot
...
class FusedTargetSnapshot(metaclass=Metaclass_FusedTargetSnapshot):
    """Message class 'FusedTargetSnapshot'."""
    ...
    _fields_and_field_types = {
        ...
        'state': 'usv_interfaces/FusedTrackSample',
        'size_w': 'double',
        'size_l': 'double',
        'size_h': 'double',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['usv_interfaces', 'msg'], 'FusedTrackSample'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from usv_interfaces.msg import FusedTrackSample
        self.state = kwargs.get('state', FusedTrackSample())
    ...
    def state(self, value):
        if __debug__:
            from usv_interfaces.msg import FusedTrackSample
            assert \
                isinstance(value, FusedTrackSample), \
                "The 'state' field must be a sub message of type 'FusedTrackSample'"
        self._state = value
