...
class GlobalTrack(metaclass=Metaclass_GlobalTrack):
    ...
    _fields_and_field_types = {
        'track_id': 'unique_identifier_msgs/UUID',
        'x': 'double',
        'y': 'double',
        'v_x': 'double',
        'v_y': 'double',
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.track_id = kwargs.get('track_id', UUID())
        ...
        self.source_model_name = kwargs.get('source_model_name', str())
    ...
    def __eq__(self, other):
        ...
        if self.matched_mmsi != other.matched_mmsi:
            return False
        if self.source_model_name != other.source_model_name:
            return False
        return True
    ...
    def track_id(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'track_id' field must be a sub message of type 'UUID'"
    ...
    def source_model_name(self):
        """Message field 'source_model_name'."""
        return self._source_model_name

    @source_model_name.setter
    def source_model_name(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'source_model_name' field must be of type 'str'"
        self._source_model_name = value
