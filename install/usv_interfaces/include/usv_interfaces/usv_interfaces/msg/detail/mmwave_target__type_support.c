...
static rosidl_typesupport_introspection_c__MessageMember usv_interfaces__msg__MmwaveTarget__rosidl_typesupport_introspection_c__MmwaveTarget_message_member_array[10] = {
  {
    "radar_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(usv_interfaces__msg__MmwaveTarget, objmotion_status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(usv_interfaces__msg__MmwaveTarget, track_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
