...
usv_interfaces__msg__GlobalTrack__init(usv_interfaces__msg__GlobalTrack * msg)
{
  ...
  // track_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->track_id)) {
  ...
  // matched_mmsi
  // source_model_name
  if (!rosidl_runtime_c__String__init(&msg->source_model_name)) {
    usv_interfaces__msg__GlobalTrack__fini(msg);
    return false;
  }
  return true;
...
usv_interfaces__msg__GlobalTrack__fini(usv_interfaces__msg__GlobalTrack * msg)
{
  ...
  // track_id
  unique_identifier_msgs__msg__UUID__fini(&msg->track_id);
  // x
  // y
  // v_x
  // v_y
  ...
  // matched_mmsi
  // source_model_name
  rosidl_runtime_c__String__fini(&msg->source_model_name);
}
...
usv_interfaces__msg__GlobalTrack__are_equal(const usv_interfaces__msg__GlobalTrack * lhs, const usv_interfaces__msg__GlobalTrack * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->source_model_name), &(rhs->source_model_name)))
  {
    return false;
  }
  return true;
  ...
  usv_interfaces__msg__GlobalTrack * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->source_model_name), &(output->source_model_name)))
  {
    return false;
  }
  return true;
