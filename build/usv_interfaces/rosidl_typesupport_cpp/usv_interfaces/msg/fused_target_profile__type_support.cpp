...
static const _FusedTargetProfile_type_support_symbol_names_t _FusedTargetProfile_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, usv_interfaces, msg, FusedTargetProfile)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, usv_interfaces, msg, FusedTargetProfile)),
  }
};
...
{
  return &::usv_interfaces::msg::rosidl_typesupport_cpp::FusedTargetProfile_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, usv_interfaces, msg, FusedTargetProfile)() {
  return get_message_type_support_handle<usv_interfaces::msg::FusedTargetProfile>();
}
