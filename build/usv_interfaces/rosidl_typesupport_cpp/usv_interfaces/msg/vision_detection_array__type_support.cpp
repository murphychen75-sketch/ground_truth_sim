...
static const _VisionDetectionArray_type_support_symbol_names_t _VisionDetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, usv_interfaces, msg, VisionDetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, usv_interfaces, msg, VisionDetectionArray)),
  }
};
...
{
  return &::usv_interfaces::msg::rosidl_typesupport_cpp::VisionDetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, usv_interfaces, msg, VisionDetectionArray)() {
  return get_message_type_support_handle<usv_interfaces::msg::VisionDetectionArray>();
}
