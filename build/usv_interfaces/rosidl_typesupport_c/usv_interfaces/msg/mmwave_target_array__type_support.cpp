...
static const _MmwaveTargetArray_type_support_symbol_names_t _MmwaveTargetArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usv_interfaces, msg, MmwaveTargetArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usv_interfaces, msg, MmwaveTargetArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usv_interfaces, msg, MmwaveTargetArray)() {
  return &::usv_interfaces::msg::rosidl_typesupport_c::MmwaveTargetArray_message_type_support_handle;
}
