...
static const _ControlDevice_Request_type_support_symbol_names_t _ControlDevice_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usv_interfaces, srv, ControlDevice_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usv_interfaces, srv, ControlDevice_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usv_interfaces, srv, ControlDevice_Request)() {
  return &::usv_interfaces::srv::rosidl_typesupport_c::ControlDevice_Request_message_type_support_handle;
}
...
static const _ControlDevice_Response_type_support_symbol_names_t _ControlDevice_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usv_interfaces, srv, ControlDevice_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usv_interfaces, srv, ControlDevice_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usv_interfaces, srv, ControlDevice_Response)() {
  return &::usv_interfaces::srv::rosidl_typesupport_c::ControlDevice_Response_message_type_support_handle;
}
...
static const _ControlDevice_type_support_symbol_names_t _ControlDevice_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usv_interfaces, srv, ControlDevice)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usv_interfaces, srv, ControlDevice)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, usv_interfaces, srv, ControlDevice)() {
  return &::usv_interfaces::srv::rosidl_typesupport_c::ControlDevice_service_type_support_handle;
}
