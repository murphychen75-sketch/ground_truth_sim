...
bool usv_interfaces__msg__fused_track_sample__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("usv_interfaces.msg._fused_track_sample.FusedTrackSample", full_classname_dest, 55) == 0);
  }
  usv_interfaces__msg__FusedTrackSample * ros_message = _ros_message;
  {  // stamp
  ...
  {  // t_sec
    PyObject * field = PyObject_GetAttrString(_pymsg, "t_sec");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->t_sec = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // x
...
{
  /* NOTE(esteve): Call constructor of FusedTrackSample */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("usv_interfaces.msg._fused_track_sample");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FusedTrackSample");
  ...
  {  // t_sec
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->t_sec);
    {
      int rc = PyObject_SetAttrString(_pymessage, "t_sec", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
