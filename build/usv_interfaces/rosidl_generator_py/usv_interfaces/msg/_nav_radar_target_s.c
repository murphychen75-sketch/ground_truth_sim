...
bool usv_interfaces__msg__nav_radar_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("usv_interfaces.msg._nav_radar_target.NavRadarTarget", full_classname_dest, 51) == 0);
  }
  usv_interfaces__msg__NavRadarTarget * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of NavRadarTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("usv_interfaces.msg._nav_radar_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NavRadarTarget");
