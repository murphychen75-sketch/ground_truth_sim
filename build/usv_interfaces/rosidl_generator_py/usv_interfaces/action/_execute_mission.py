    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'usv_interfaces.action.ExecuteMission_Goal')
            logger.debug(
...
class ExecuteMission_Goal(metaclass=Metaclass_ExecuteMission_Goal):
    ...
    __slots__ = [
        '_mission_file_name',
        '_forbidden_zone_file',
        '_loop_execution',
    ]

    _fields_and_field_types = {
        'mission_file_name': 'string',
        'forbidden_zone_file': 'string',
    ...
    def __init__(self, **kwargs):
        ...
        self.mission_file_name = kwargs.get('mission_file_name', str())
        self.forbidden_zone_file = kwargs.get('forbidden_zone_file', str())
        self.loop_execution = kwargs.get('loop_execution', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.mission_file_name != other.mission_file_name:
            return False
        if self.forbidden_zone_file != other.forbidden_zone_file:
            return False
        if self.loop_execution != other.loop_execution:
            return False
        return True
    ...
    @builtins.property
    def mission_file_name(self):
        """Message field 'mission_file_name'."""
        return self._mission_file_name

    @mission_file_name.setter
    def mission_file_name(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'mission_file_name' field must be of type 'str'"
        self._mission_file_name = value

    @builtins.property
    def forbidden_zone_file(self):
        """Message field 'forbidden_zone_file'."""
        return self._forbidden_zone_file

    @forbidden_zone_file.setter
    def forbidden_zone_file(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'forbidden_zone_file' field must be of type 'str'"
        self._forbidden_zone_file = value

    @builtins.property
    def loop_execution(self):
        """Message field 'loop_execution'."""
        return self._loop_execution

    @loop_execution.setter
    def loop_execution(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'loop_execution' field must be of type 'bool'"
        self._loop_execution = value
...
class Metaclass_ExecuteMission_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'usv_interfaces.action.ExecuteMission_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecuteMission_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'usv_interfaces.action.ExecuteMission_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_Feedback(metaclass=Metaclass_ExecuteMission_Feedback):
    ...
    def __init__(self, **kwargs):
        ...
        self.mission_progress = kwargs.get('mission_progress', float())
    ...
    def __eq__(self, other):
        ...
        if self.current_waypoint_index != other.current_waypoint_index:
            return False
        if self.mission_progress != other.mission_progress:
            return False
    ...
    def mission_progress(self):
        """Message field 'mission_progress'."""
        return self._mission_progress

    @mission_progress.setter
    def mission_progress(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'mission_progress' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'mission_progress' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._mission_progress = value
...
class Metaclass_ExecuteMission_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from usv_interfaces.action import ExecuteMission
...
class ExecuteMission_SendGoal_Request(metaclass=Metaclass_ExecuteMission_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'usv_interfaces/ExecuteMission_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['usv_interfaces', 'action'], 'ExecuteMission_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from usv_interfaces.action._execute_mission import ExecuteMission_Goal
...
class Metaclass_ExecuteMission_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'usv_interfaces.action.ExecuteMission_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from usv_interfaces.action import _execute_mission
...
class ExecuteMission_SendGoal(metaclass=Metaclass_ExecuteMission_SendGoal):
    from usv_interfaces.action._execute_mission import ExecuteMission_SendGoal_Request as Request
    from usv_interfaces.action._execute_mission import ExecuteMission_SendGoal_Response as Response
...
class ExecuteMission_GetResult_Response(metaclass=Metaclass_ExecuteMission_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'usv_interfaces/ExecuteMission_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['usv_interfaces', 'action'], 'ExecuteMission_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from usv_interfaces.action._execute_mission import ExecuteMission_Result
...
class Metaclass_ExecuteMission_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'usv_interfaces.action.ExecuteMission_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_GetResult(metaclass=Metaclass_ExecuteMission_GetResult):
    from usv_interfaces.action._execute_mission import ExecuteMission_GetResult_Request as Request
    from usv_interfaces.action._execute_mission import ExecuteMission_GetResult_Response as Response
...
class Metaclass_ExecuteMission_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'usv_interfaces.action.ExecuteMission_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_FeedbackMessage(metaclass=Metaclass_ExecuteMission_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'usv_interfaces/ExecuteMission_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['usv_interfaces', 'action'], 'ExecuteMission_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from usv_interfaces.action._execute_mission import ExecuteMission_Feedback
...
class Metaclass_ExecuteMission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'usv_interfaces.action.ExecuteMission')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission(metaclass=Metaclass_ExecuteMission):
    ...
    from usv_interfaces.action._execute_mission import ExecuteMission_Goal as Goal
    # The result message defined in the action definition.
    from usv_interfaces.action._execute_mission import ExecuteMission_Result as Result
    # The feedback message defined in the action definition.
    from usv_interfaces.action._execute_mission import ExecuteMission_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from usv_interfaces.action._execute_mission import ExecuteMission_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from usv_interfaces.action._execute_mission import ExecuteMission_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from usv_interfaces.action._execute_mission import ExecuteMission_FeedbackMessage as FeedbackMessage
