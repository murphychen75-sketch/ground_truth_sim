...
#include "usv_interfaces/msg/detail/ais_track__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const usv_interfaces::msg::AISTrack & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: mmsi
  cdr << ros_message.mmsi;
  // Member: ship_name
  cdr << ros_message.ship_name;
  // Member: relative_x
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  usv_interfaces::msg::AISTrack & ros_message)
{
  // Member: mmsi
  cdr >> ros_message.mmsi;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = usv_interfaces::msg::AISTrack;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const usv_interfaces::msg::AISTrack *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<usv_interfaces::msg::AISTrack *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AISTrack__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const usv_interfaces::msg::AISTrack *>(
...
static size_t _AISTrack__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AISTrack(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AISTrack__callbacks = {
  "usv_interfaces::msg",
  "AISTrack",
...
static rosidl_message_type_support_t _AISTrack__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AISTrack__callbacks,
...
{
  return &usv_interfaces::msg::typesupport_fastrtps_cpp::_AISTrack__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, usv_interfaces, msg, AISTrack)() {
  return &usv_interfaces::msg::typesupport_fastrtps_cpp::_AISTrack__handle;
}
