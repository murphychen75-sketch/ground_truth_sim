...
#include "usv_interfaces/msg/detail/control_deviation__rosidl_typesupport_fastrtps_c.h"
...
using _ControlDeviation__ros_msg_type = usv_interfaces__msg__ControlDeviation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ControlDeviation__ros_msg_type * ros_message = static_cast<const _ControlDeviation__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ControlDeviation__ros_msg_type * ros_message = static_cast<_ControlDeviation__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_usv_interfaces__msg__ControlDeviation(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControlDeviation__ros_msg_type * ros_message = static_cast<const _ControlDeviation__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ControlDeviation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_usv_interfaces__msg__ControlDeviation(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_usv_interfaces
size_t max_serialized_size_usv_interfaces__msg__ControlDeviation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = usv_interfaces__msg__ControlDeviation;
    is_plain =
      (
...
static size_t _ControlDeviation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_usv_interfaces__msg__ControlDeviation(
...
static message_type_support_callbacks_t __callbacks_ControlDeviation = {
  "usv_interfaces::msg",
  "ControlDeviation",
...
static rosidl_message_type_support_t _ControlDeviation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ControlDeviation,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usv_interfaces, msg, ControlDeviation)() {
  return &_ControlDeviation__type_support;
}
